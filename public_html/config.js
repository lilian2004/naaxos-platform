...
window.NAAXOS_CONFIG = {
  ...
  // ======================================
  // GROQ API (LLM Chat/IA - Optionnel)
  // → vraie clé dans config.local.js (ou idéalement un proxy backend)
  // ======================================
  GROQ_API_KEY: 'gsk_YOUR_GROQ_API_KEY_HERE',
  GROQ_MODEL: 'mixtral-8x7b-32768', // ou 'llama-3-8b-instant'
  GROQ_ENABLED: false, // Mettre true pour activer le chat
...
window.LLM_CONFIG = {
  ...
  apiKey: window.NAAXOS_CONFIG.GROQ_API_KEY,
  model: window.NAAXOS_CONFIG.GROQ_MODEL,
